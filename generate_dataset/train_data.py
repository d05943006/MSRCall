...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--threads', default=6, required=False, type=int,
    ...
    parser.add_argument('-raw_len', type=int, default=256, required=False)
    parser.add_argument('-seq_len', type=int, default=70, required=False)
